...
@media(max-width:440px){.live-state{font-size:8px}.live-state i{width:8px;height:8px}.freeze-button{min-width:78px;padding:0 6px}.session-state{gap:4px}.alerts-menu{right:-42px}.alert-action{min-width:75px}.context-trigger small{max-width:180px}}
