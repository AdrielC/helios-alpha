    ...
    <div class="identity-cluster">
      <button class="product-identity" aria-label="Open operations" @click="selectView('operations')">
        <svg class="helios-mark" viewBox="0 0 28 28" aria-hidden="true">
          ...
          <path class="mark-orbit" d="M3.8 14c0-5.6 4.6-10.2 10.2-10.2S24.2 8.4 24.2 14 19.6 24.2 14 24.2 3.8 19.6 3.8 14Z" />
          <path class="mark-arc" d="M5.8 7.5c4.7 3.1 11.8 4.4 16.7 1.2M5.5 20.1c4-3.7 11.8-5.5 17-2.1" />
          <path d="M14 1.8v3M14 23.2v3M1.8 14h3M23.2 14h3" />
          <circle class="mark-node" cx="22.5" cy="8.7" r="1.15" />
        </svg>
...
@media(max-width:900px){.status-chip{display:none}.context-trigger{max-width:230px}}
@media(max-width:560px){.app-header{position:static;display:flex;flex-wrap:wrap}.identity-cluster{width:100%;min-height:56px;border-bottom:1px solid var(--atlas-rule)}.product-identity{padding:0 12px}.context-control{flex:1}.context-trigger{max-width:calc(100vw - 108px)}.session-state{display:grid;grid-template-columns:1fr auto auto;width:100%;min-height:auto;padding:8px 12px}.operator-trigger strong,.operator-trigger>svg{display:none}.context-menu{position:fixed;top:56px;right:8px;left:8px;width:auto}.alerts-menu{right:-45px}}
@media(max-width:440px){.live-state{font-size:8px}.live-state i{width:8px;height:8px}.session-state{gap:4px}.alerts-menu{right:-42px}.alert-action{min-width:75px}.context-trigger small{max-width:180px}}
